...
<!-- End Meta Pixel Code -->
        ...
        @stack('seo') 
        @stack('css')
 <link rel="stylesheet" href="{{asset('public/frontEnd/css/bootstrap.min.css?v=2')}}" />
<link rel="stylesheet" href="{{asset('public/frontEnd/css/animate.css?v=2')}}" />
<link rel="stylesheet" href="{{asset('public/frontEnd/css/all.min.css?v=2')}}" />
<link rel="stylesheet" href="{{asset('public/frontEnd/css/owl.carousel.min.css?v=2')}}" />
<link rel="stylesheet" href="{{asset('public/frontEnd/css/owl.theme.default.min.css?v=2')}}" />
<link rel="stylesheet" href="{{asset('public/frontEnd/css/mobile-menu.css?v=2')}}" />
<link rel="stylesheet" href="{{asset('public/frontEnd/css/select2.min.css?v=2')}}" />
<!-- toastr css -->
<link rel="stylesheet" href="{{asset('public/backEnd/assets/css/toastr.min.css?v=2')}}" />

<link rel="stylesheet" href="{{asset('public/frontEnd/css/wsit-menu.css?v=2')}}" />
<link rel="stylesheet" href="{{asset('public/frontEnd/css/style.css?v=2')}}" />
<link rel="stylesheet" href="{{asset('public/frontEnd/css/responsive.css?v=2')}}" />
<link rel="stylesheet" href="{{asset('public/frontEnd/css/main.css?v=2')}}" />
                            ...
                            <div class="col-sm-12">
                                <div class="catagory_menu">
                                    <ul class="heder__category">
                                        ...
                                        <div><li><a href="{{route('hotdeals')}}">Special</a></li></div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="copyright">
								...
								<p><span style="color: white;">Copyright © {{ date('Y') }} {{$generalsetting->name}}. All rights reserved </span> | <span style="color: white;">Website Designed by: <a href="https://www.borbila.com"><span style="color: white;">Borbila</span></a></span></p>
                            </div>
                        </div>
                    </div>
                </div>
