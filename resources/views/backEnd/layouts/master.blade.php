...
@endif
  ...
  <a href="{{ url('admin/dashboard') }}">
    <img src="{{ asset('public/backEnd/assets/images/menu-icons/dashboard.png') }}" 
    ...
    <span> Dashboard </span>
              ...
              <li>
                <a href="#sidebar-orders" data-bs-toggle="collapse">
                  <img src="{{ asset('public/backEnd/assets/images/menu-icons/order.svg') }}" 
         alt="Dashboard Icon" width="20" height="20" style="vertical-align: middle; margin-right: 8px;">
                  <span> Orders </span>
              ...
              <li>
                <a href="#siebar-product" data-bs-toggle="collapse">
                  <img src="{{ asset('public/backEnd/assets/images/menu-icons/product.png') }}" 
         alt="Dashboard Icon" width="20" height="20" style="vertical-align: middle; margin-right: 8px;">
                  <span> Products </span>
                  <span class="menu-arrow"></span>
                </a>
              ...
              <li>
                <a href="#sidebar-product-review" data-bs-toggle="collapse">
                  <img src="{{ asset('public/backEnd/assets/images/menu-icons/review.png') }}" 
         alt="Dashboard Icon" width="20" height="20" style="vertical-align: middle; margin-right: 8px;">
                  <span> Reviews </span>
                  <span class="menu-arrow"></span>
                </a>
              ...
              <li>
                <a href="#sidebar-users" data-bs-toggle="collapse">
                  <img src="{{ asset('public/backEnd/assets/images/menu-icons/user.png') }}" 
         alt="Dashboard Icon" width="20" height="20" style="vertical-align: middle; margin-right: 8px;">
                  <span> Users </span>
                  <span class="menu-arrow"></span>
                </a>
              ...
              <li>
                <a href="#siebar-sitesetting" data-bs-toggle="collapse">
                  <img src="{{ asset('public/backEnd/assets/images/menu-icons/setting.png') }}" 
         alt="Dashboard Icon" width="20" height="20" style="vertical-align: middle; margin-right: 8px;">
              ...
              <li>
                <a href="#sidebar-api-integration" data-bs-toggle="collapse">
                  <img src="{{ asset('public/backEnd/assets/images/menu-icons/api.png') }}" 
         alt="Dashboard Icon" width="20" height="20" style="vertical-align: middle; margin-right: 8px;">
              ...
              <li>
                <a href="#sidebar-pixel-gtm" data-bs-toggle="collapse">
                  <img src="{{ asset('public/backEnd/assets/images/menu-icons/pixel.png') }}" 
         alt="Dashboard Icon" width="20" height="20" style="vertical-align: middle; margin-right: 8px;">
              ...
              <li>
                <a href="#siebar-banner" data-bs-toggle="collapse">
                  <img src="{{ asset('public/backEnd/assets/images/menu-icons/ad.png') }}" 
         alt="Dashboard Icon" width="20" height="20" style="vertical-align: middle; margin-right: 8px;">
              ...
              <li>
                <a href="#sitebar-report" data-bs-toggle="collapse">
                  <img src="{{ asset('public/backEnd/assets/images/menu-icons/report.png') }}" 
         alt="Dashboard Icon" width="20" height="20" style="vertical-align: middle; margin-right: 8px;">
                  <span> Reports </span>
                  <span class="menu-arrow"></span>
                </a>
