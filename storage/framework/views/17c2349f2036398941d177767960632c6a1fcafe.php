...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group mb-3">
                                <button type="submit" class="submit-btnn">মেসেজ পাঠান</button>
                            </div>
                        </div>
                        <!-- col-end -->
                    </form>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u315696686/domains/buyshop.borbila.net/public_html/resources/views/frontEnd/layouts/pages/contact.blade.php ENDPATH**/ ?>