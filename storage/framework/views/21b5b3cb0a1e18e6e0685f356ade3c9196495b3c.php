...
<div class="card mt-4">
  <div class="card-body">
    ...
    <form action="<?php echo e(route('paymentgeteway.update')); ?>" method="POST">
      <?php echo csrf_field(); ?>
      <input type="hidden" name="id" value="<?php echo e($moynapay->id ?? ''); ?>">
        ...
        <div class="col-sm-6">
          <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" name="app_key"
                   value="<?php echo e($moynapay->app_key ?? ''); ?>" required>
          </div>
        </div>
        ...
        <div class="col-sm-6">
          <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" name="base_url"
                   value="<?php echo e($moynapay->base_url ?? 'https://pay.moynapay.com/api'); ?>" required>
          </div>
        </div>
          ...
          <div class="form-group">
            ...
            <label class="switch">
              <input type="checkbox" value="1" name="status"
                     <?php if(isset($moynapay) && $moynapay->status==1): ?> checked <?php endif; ?>>
              <span class="slider round"></span>
            </label>
          </div>
        </div>
...
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u315696686/domains/buyshop.borbila.net/public_html/resources/views/backEnd/apiintegration/pay_manage.blade.php ENDPATH**/ ?>