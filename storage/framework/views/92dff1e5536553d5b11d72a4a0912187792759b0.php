...
unset($__errorArgs, $__bag); ?>
  ...
  <input class="form-check-input" type="radio" name="payment_method" id="pay_moyna" value="moynapay">
  <label class="form-check-label" for="pay_moyna">
    Pay with MoynaPay
  </label>
</div>
...
<?php echo $__env->make('frontEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u315696686/domains/buyshop.borbila.net/public_html/resources/views/frontEnd/layouts/customer/checkout.blade.php ENDPATH**/ ?>