...
<?php $__env->startSection('title','Special'); ?>
    ...
    <div class="col-sm-12">
        <div class="category-product main_product_inner">
            ...
            <div class="product_item wist_item wow zoomIn" data-wow-duration="1.5s"
                ...
                <!-- Updated Button: Always goes to product details page -->
                <div class="pro_btn">
                    <div class="cart_btn order_button">
                        <a href="<?php echo e(route('product', $value->slug)); ?>" class="viewproductbutton">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u315696686/domains/buyshop.borbila.net/public_html/resources/views/frontEnd/layouts/pages/hotdeals.blade.php ENDPATH**/ ?>