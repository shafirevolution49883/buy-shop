...
<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css" rel="stylesheet">
  ...
  <body data-layout-mode="default" data-theme="light" data-layout-width="fluid" data-topbar-color="dark" data-menu-position="fixed" data-leftbar-color="light" data-leftbar-size="default" data-sidebar-user="false">
        ...
        <div class="container-fluid">
          ...
          <div class="logo-box">
            <a href="<?php echo e(url('admin/dashboard')); ?>" class="logo logo-dark text-center">
              <span class="logo-sm">
                <img src="<?php echo e(asset($generalsetting->white_logo)); ?>" alt="" height="50" />
    ...
    <div style="color: white; padding: 15px 0px 0px 0px; text-align: center; font-size: 20px; font-weight: bold;">
        Demo Mode Active
    </div>
<?php endif; ?>
  ...
  <a href="<?php echo e(url('admin/dashboard')); ?>">
    <img src="<?php echo e(asset('public/backEnd/assets/images/menu-icons/dashboard.png')); ?>" 
         alt="Dashboard Icon" width="20" height="20" style="vertical-align: middle; margin-right: 8px;">
    <span> Dashboard </span>
  </a>
</li>
              ...
              <li>
                <a href="#sidebar-orders" data-bs-toggle="collapse">
                  <img src="<?php echo e(asset('public/backEnd/assets/images/menu-icons/order.svg')); ?>" 
         alt="Dashboard Icon" width="20" height="20" style="vertical-align: middle; margin-right: 8px;">
                  <span> Orders </span>
              ...
              <li>
                <a href="#siebar-product" data-bs-toggle="collapse">
                  <img src="<?php echo e(asset('public/backEnd/assets/images/menu-icons/product.png')); ?>" 
         alt="Dashboard Icon" width="20" height="20" style="vertical-align: middle; margin-right: 8px;">
                  <span> Products </span>
                  <span class="menu-arrow"></span>
                </a>
              ...
              <li>
                <a href="#sidebar-product-review" data-bs-toggle="collapse">
                  <img src="<?php echo e(asset('public/backEnd/assets/images/menu-icons/review.png')); ?>" 
         alt="Dashboard Icon" width="20" height="20" style="vertical-align: middle; margin-right: 8px;">
                  <span> Reviews </span>
                  <span class="menu-arrow"></span>
                </a>
              ...
              <li>
                <a href="#sidebar-users" data-bs-toggle="collapse">
                  <img src="<?php echo e(asset('public/backEnd/assets/images/menu-icons/user.png')); ?>" 
         alt="Dashboard Icon" width="20" height="20" style="vertical-align: middle; margin-right: 8px;">
                  <span> Users </span>
                  <span class="menu-arrow"></span>
                </a>
              ...
              <li>
                <a href="#siebar-sitesetting" data-bs-toggle="collapse">
                  <img src="<?php echo e(asset('public/backEnd/assets/images/menu-icons/setting.png')); ?>" 
         alt="Dashboard Icon" width="20" height="20" style="vertical-align: middle; margin-right: 8px;">
              ...
              <li>
                <a href="#sidebar-api-integration" data-bs-toggle="collapse">
                  <img src="<?php echo e(asset('public/backEnd/assets/images/menu-icons/api.png')); ?>" 
         alt="Dashboard Icon" width="20" height="20" style="vertical-align: middle; margin-right: 8px;">
              ...
              <li>
                <a href="#sidebar-pixel-gtm" data-bs-toggle="collapse">
                  <img src="<?php echo e(asset('public/backEnd/assets/images/menu-icons/pixel.png')); ?>" 
         alt="Dashboard Icon" width="20" height="20" style="vertical-align: middle; margin-right: 8px;">
              ...
              <li>
                <a href="#siebar-banner" data-bs-toggle="collapse">
                  <img src="<?php echo e(asset('public/backEnd/assets/images/menu-icons/ad.png')); ?>" 
         alt="Dashboard Icon" width="20" height="20" style="vertical-align: middle; margin-right: 8px;">
              ...
              <li>
                <a href="#sitebar-report" data-bs-toggle="collapse">
                  <img src="<?php echo e(asset('public/backEnd/assets/images/menu-icons/report.png')); ?>" 
         alt="Dashboard Icon" width="20" height="20" style="vertical-align: middle; margin-right: 8px;">
                  <span> Reports </span>
                  <span class="menu-arrow"></span>
                </a>
      ...
      <div class="content-page">
        ...
        <footer class="footer">
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12 text-end"><a href="https://borbila.com" target="_blank">Website Designed by: Borbila</a></div>
            </div>
          </div>
        </footer>
        <!-- end Footer -->
...
<?php /**PATH /home/u315696686/domains/buyshop.borbila.net/public_html/resources/views/backEnd/layouts/master.blade.php ENDPATH**/ ?>