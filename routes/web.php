...
// MoynaPay Routes
Route::match(['get','post'], '/moynapay/create', [App\Http\Controllers\Frontend\MoynaPayController::class, 'create'])
    ->name('moynapay.create');

Route::get('/moynapay/success', [App\Http\Controllers\Frontend\MoynaPayController::class, 'success'])
    ->name('moynapay.success');

Route::get('/moynapay/cancel', [App\Http\Controllers\Frontend\MoynaPayController::class, 'cancel'])
    ->name('moynapay.cancel');

Route::post('/moynapay/webhook', [App\Http\Controllers\Frontend\MoynaPayController::class, 'webhook'])
    ->name('moynapay.webhook');
